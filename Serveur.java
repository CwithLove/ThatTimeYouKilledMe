...
public class Serveur {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (compteurClients < 2) {
            ...
            new Thread(new ReceptionClient(in, fileEntrante, clientId)).start();
            new Thread(new EmissionClient(out, fileSortante)).start();

            System.out.println("Client " + clientId + " connecté.");
        }

        moteur = new Thread(new Jeu(fileEntrante, filesSortantes));
        moteur.start();
